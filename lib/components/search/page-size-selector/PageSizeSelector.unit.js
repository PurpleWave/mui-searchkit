    ...
    beforeEach(function () {
        ...
        _this.setWrapper = function (props) {
            ...
            _this.wrapper = enzyme_1.mount(React.createElement("div", null,
                React.createElement(__1.PageSizeSelector, __assign({ options: [4, 12, 24], searchkit: _this.searchkit }, props)),
                React.createElement(__1.Hits, { hitsPerPage: 12, searchkit: _this.searchkit })));
