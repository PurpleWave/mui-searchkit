...
describe("TagFilterList tests", function () {
    ...
    it('handles click', function () {
        ...
        expect(_this.wrapper).toMatchSnapshot("option 1 active, option 2 not active");
        expect(_this.accessor.state.getValue()).toEqual(['test option 1']);
        TestHelpers_1.fastClick(option2);
        expect(_this.wrapper).toMatchSnapshot("option 1 active, option 2 active");
        TestHelpers_1.fastClick(option);
        expect(_this.wrapper).toMatchSnapshot("option 1 not active, option 2 active");
        TestHelpers_1.fastClick(option2);
