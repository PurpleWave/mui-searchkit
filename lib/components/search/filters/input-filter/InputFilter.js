    ...
    InputFilter.prototype.render = function () {
        ...
        return core_1.renderComponent(containerComponent, {
            ...
            React.createElement("form", { onSubmit: this.onSubmit.bind(this) },
                React.createElement(TextField_1.default, { className: 'fullWidthInput', label: 'Search', value: value, onFocus: this.setFocusState.bind(this, true), onBlur: this.setFocusState.bind(this, false), autoFocus: false, onInput: this.onChange.bind(this) }),
