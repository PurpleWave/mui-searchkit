    ...
    SearchBox.prototype.render = function () {
        ...
        return (React.createElement("div", { className: block().state({ focused: this.state.focused }) },
            React.createElement("form", { style: { alignItems: 'baseline', flexDirection: 'row' }, onSubmit: this.onSubmit.bind(this) },
                React.createElement(Grid_1.default, { container: true, spacing: 8, alignItems: 'flex-end', style: { marginBottom: 12 } },
                    React.createElement(Grid_1.default, { item: true },
                        React.createElement(Search_1.default, null)),
                    React.createElement(Grid_1.default, { item: true, style: { flex: '1 0 auto' } },
                        React.createElement(TextField_1.default, { type: 'text', "data-qa": 'query', className: 'fullWidthInput', placeholder: this.props.placeholder, label: 'Search', value: this.getValue(), onFocus: this.setFocusState.bind(this, true), onBlur: this.setFocusState.bind(this, false), autoFocus: this.props.autofocus, onInput: this.onChange.bind(this) }))),
                React.createElement("input", { type: "submit", value: this.translate("searchbox.button"), className: block("action"), "data-qa": "submit" }),
                React.createElement(CircularProgress_1.default, { color: 'secondary', "data-qa": 'loader', style: { opacity: this.isLoading() ? 1 : 0 } }))));
    };
